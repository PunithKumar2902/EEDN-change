...
def type_loss(prediction, label__, label, event_time, test_label, que_test_label, opt):
    ...
    multi_hots = multi_hots * (1 - opt.smooth) + (1 - multi_hots) * opt.smooth / C.USER_NUMBER
